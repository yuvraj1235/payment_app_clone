          ...
          const subscriber = firestore()
            ...
            .onSnapshot(documentSnapshot => {
              if (documentSnapshot.exists) {
                ...
                setUserEmail(userData.email || currentUser.email); // Fallback to auth email
                setUsername(userData.username || 'N/A');
                setError(null); // Clear any previous errors
              } else {
                // User document does not exist, use auth email and default username
                setUserEmail(currentUser.email);
                setUsername('User'); // Default username
        ...
        {error ? (
            ...
            <>
                ...
                <View style={styles.bottomSectionPlaceholder}>
                    <Text style={styles.bottomSectionText}>Methods</Text>
